...
If you don't have our ISBCGCExamples downloaded, go to https://github.com/isb-cgc/examples-R
...
substituting the cohord ID.

```{r}
barcodes  <- barcodes_from_cohort("your_cohort_id_here", mytoken)
...
Secondly, let's suppose you have a list of genes in a file.

```{r}
gene_table <- read.table("~/Desktop/notch_pathway_genes.txt", sep="\t", header=T, stringsAsFactors=F)
notch_genes - gene_table$Gene.Name
```

We're interested in this platform: IlluminaHiSeq_RNASeqV2 which is found
in "[isb-cgc:tcga_201510_alpha.mRNA_UNC_HiSeq_RSEM]"
